public class Translator
{
    public static void Run()
    {
        ...
        englishToGerman.AddWord("Ambulance", "KrankenWagen");
        englishToGerman.AddWord("Bicycle", "Fahrrad");
        Console.WriteLine(englishToGerman.Translate("Car")); // Auto
        Console.WriteLine(englishToGerman.Translate("Plane")); // Flugzeug
        Console.WriteLine(englishToGerman.Translate("Ambulance")); // KrankenWagen
        Console.WriteLine(englishToGerman.Translate("Train")); // ???
        Console.WriteLine(englishToGerman.Translate("Hospital")); // ???
    }
    ...
    {
        string toWord;
        if (_words.TryGetValue(fromWord, out toWord))
        {
            return toWord;
        }
        else
