...
public static class SetsAndMaps
{
    ...
    /// For each earthquake in the feature collection, get the magnitude and place
    /// Add the formatted string matching what the test requires to pass to the summary list
    ...
    public static string[] EarthquakeDailySummary()
    {
        ...
        foreach (var earthquake in featureCollection.Features)
        {
            ...
            earthquakeSummary.Add($"{place}, - Mag {mag}");
        }
        return earthquakeSummary.ToArray();
